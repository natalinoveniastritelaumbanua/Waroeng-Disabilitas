                ...
                foreach ($data as $produk) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <img src="images/<?= $produk['foto_produk']; ?>" alt="Foto Produk" width="100">
                    </td>
                    <td><?= $produk['status_produk']; ?></td>
                    <td>
                      <a href="ubah_produk.php?id_produk=<?= $produk['id_produk'] ?>" class="btn btn-sm btn-warning">
                        <i class="fas fa-edit mr-1"></i>Ubah</a>
                      <a href="hapus_produk_aksi.php?id_produk=<?= $produk['id_produk'] ?>" class="btn btn-sm btn-danger" onclick='return-confirm("Yakin hapus?")'>
                        <i class="fas fa-trash mr-1"></i>Hapus</a>
                    </td>
                  </tr>
                <?php } ?>
